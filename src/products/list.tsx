          ...
          renderItem={({ item }) => (
            <View style={numcol == 2 ? styles.cardgrid : styles.cardlist}>
              <TouchableOpacity style={{ flexDirection : 'column', alignItems : 'center', padding :2 }} onPress={() =>
                ...
                <Image resizeMode='contain' source={{ uri: `https://gmtnew.mo.vc/web/image?model=product.template&id=${item.id}&field=image_128` }} style={numcol == 2 ? styles.tinyLogogrid : styles.tinyLogolist}></Image>
